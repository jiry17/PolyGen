...
(check-synth)
(define-fun res ((Param0 Int) (Param1 Int) (Param2 Int) (Param3 Int) (Param4 Int) (Param5 Int) (Param6 Int) (Param7 Int)) Int (ite (<= Param6 Param7) 7 (ite (<= Param5 Param7) 6 (ite (<= Param4 Param7) 5 (ite (<= Param3 Param7) 4 (ite (<= Param2 Param7) 3 (ite (<= Param1 Param7) 2 (ite (<= Param0 Param7) 1 0))))))))