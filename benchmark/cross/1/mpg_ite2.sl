...
(define-fun res ((Param0 Int) (Param1 Int) (Param2 Int)) Int (ite (and (<= 1 (+ Param0 Param2)) (<= 1 (+ Param0 Param1))) (+ Param0 1) (ite (or (<= (+ Param1 Param2) 0) (<= 1 (+ Param0 Param1))) (+ Param1 1) (+ Param2 1))))