...
(check-synth)
(define-fun res ((Param0 Int) (Param1 Int) (Param2 Int) (Param3 Int) (Param4 Int) (Param5 Int) (Param6 Int) (Param7 Int) (Param8 Int) (Param9 Int) (Param10 Int) (Param11 Int)) Int (ite (<= Param10 Param11) 11 (ite (<= Param9 Param11) 10 (ite (<= Param8 Param11) 9 (ite (<= Param7 Param11) 8 (ite (<= Param6 Param11) 7 (ite (<= Param5 Param11) 6 (ite (<= Param4 Param11) 5 (ite (<= Param3 Param11) 4 (ite (<= Param2 Param11) 3 (ite (<= Param1 Param11) 2 (ite (and (<= Param11 Param1) (<= Param0 Param11)) 1 0))))))))))))