...
(check-synth)
(define-fun res ((Param0 Int) (Param1 Int) (Param2 Int) (Param3 Int) (Param4 Int) (Param5 Int)) Int (ite (<= Param4 Param5) 5 (ite (<= Param3 Param5) 4 (ite (<= Param2 Param5) 3 (ite (<= Param1 Param5) 2 (ite (and (<= Param5 Param1) (<= Param0 Param5)) 1 0))))))